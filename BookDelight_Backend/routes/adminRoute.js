...
const {getDashboard, deleteReplyByAdmin, deleteReviewByAdmin, deleteBookByAdmin} = require("../controllers/adminController");
...
router.delete('/book/', authenticateToken, checkAdmin, deleteBookByAdmin);
