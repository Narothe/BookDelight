            ...
            {data.length > 0 ? (
                <div>
                    <div className="hidden md:block">
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 border flex-wrap gap-2 pt-4 p-2 mb-4 rounded-md shadow-md bg-custom-new-white">
                            {data.map((item) => (
                                    ...
                                    <div className="relative">
                                        <div className="lg:mt-6">
                                            <div className="absolute right-0 bottom-0 mr-1">
                                                <i className="text-sm lg:text-base text-gray-400 ">Click and see more</i>
                                            </div>
                                        </div>
                                    </div>
                                    </Link>
