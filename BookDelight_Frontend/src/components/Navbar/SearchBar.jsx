        ...
        <div className="flex w-full">
            <div className="flex flex-auto flex-row w-5/6 justify-between">
                ...
                <div className="grid justify-items-center content-center h-auto mr-2 ">
                    <button
                        className="grid justify-items-center content-center w-8 h-8 rounded-full overflow-hidden border-4 border-custom-new-light-dark hover:border-custom-new-dark active:border-custom-new-light">
