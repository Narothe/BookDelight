        ...
        <div className="flex w-full">
            <div className="flex flex-auto flex-row w-5/6 justify-between">
                ...
                <div className="grid justify-items-center content-center h-auto mr-2 ">
                    <button
                        className="grid justify-items-center content-center w-8 h-8 rounded-full overflow-hidden border-4 border-orange-100 hover:border-orange-200 active:border-custom-light-blue">
